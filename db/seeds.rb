...
@recipe5 = @admin3.recipes.create!(directions: 'Follow recipe link for cooking instructions.', name: 'Fresh tomato broth', image: open_asset('default-soup.jpeg'), description: 'no user description', cooking_time: '110 minutes', source: 'Jamie Oliver', recipe_url: 'http://www.jamieoliver.com/recipes/vegetables-recipes/fresh-tomato-broth/')
@recipe6 = @admin4.recipes.create!(directions: 'Follow recipe link for cooking instructions.', name: 'DIY Instant Tomato Bell Pepper Soup Recipe', image: open_asset('default-soup.jpeg'), description: 'no user description', cooking_time: '2 minutes', source: 'Serious Eats', recipe_url: 'http://www.seriouseats.com/recipes/2013/02/diy-instant-tomato-bell-pepper-soup-recipe.html')
